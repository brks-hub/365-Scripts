...
$appfolder = New-Item -Path ".\" -Name "HPIA" -ItemType Directory -Force
$downloadsource = 'https://raw.githubusercontent.com/brks-hub/365-Scripts/main/Intune/Installers/HPIA.exe' 
$filename = "HPIA.exe"
...
# Set app metadata
$Displayname = "HPIA"
$Description = "HP Image Assistant - Installs HPIA, looks for device drivers, silently installs and then uninstalls the HPIA program - HPIA.ps1"
$Publisher = "HPIA"

# Detection Rule for Intune
$DetectionRule = New-IntuneWin32AppDetectionRuleFile -Existence -FileOrFolder RemoveBloat.exe -Path "C:\HPIA\" -Check32BitOn64System $false -DetectionType "exists"
